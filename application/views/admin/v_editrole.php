        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form action="<?= base_url('Admin/EditHakAkses/') . $HakAkses['ID']; ?>" method="post" enctype="multipart/form-data">
                        <!-- HARUS ADA ID JIKA INGIN EDIT/UPDATE -->
                        <input type="hidden" name="ID" value="<?= $HakAkses['ID']; ?>">
                        <div class=" form-group row">
                            <label class="col-sm-3 col-form-label">Role</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="hakakses" value="<?= $HakAkses['HakAkses']; ?>">
                            </div>
                        </div>

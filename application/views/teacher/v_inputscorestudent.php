    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-11">
          ...
          <div class="row">
            <div class="col">
              <a href="#" class="au-btn au-btn-icon au-btn--blue mb-3" data-toggle="modal" data-target="#NewScoreModal"><i class="zmdi zmdi-plus"></i>Add Score Student</a>
            </div>
          </div>
              ...
              <tbody>
                ...
                <?php foreach ($NilaiSiswa as $NS) : ?>
                  <tr>
                    ...
                    <td><?= $NS['NIS']; ?> </td>
                    <td><?= $NS['Nama_Siswa']; ?> </td>
                    <td><?= $NS['Matapelajaran_ID']; ?> </td>
                    <td><?= $NS['Kelas_ID']; ?> </td>
                    <td><?= $NS['Nilai_Tugas_1']; ?> </td>
                    <td><?= $NS['Nilai_Tugas_2']; ?> </td>
                    <td><?= $NS['Nilai_Tugas_3']; ?> </td>
                    <td><?= $NS['Nilai_UTS']; ?> </td>
                    <td><?= $NS['Nilai_UAS']; ?> </td>
                    <td>
                      <a href="<?= base_url('Teacher/EditInputNilaiSiswa/') . $NS['ID']; ?>" class="badge badge-success">Edit</a>
                      <a href="<?= base_url('Teacher/HapusInputNilaiSiswa/') . $NS['ID']; ?>" class="badge badge-danger">Delete</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="NewScoreModalLabel">Add Score Student</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">x</span>
        </button>
      </div>
      <form action="<?= base_url('Teacher/InputNilaiSiswa'); ?>" method="post" enctype="multipart/form-data">
